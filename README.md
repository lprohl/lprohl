...
- 1С (проектирование архитектуры решений, формирование ТЗ, программирование, тестирование, документирование, внедрение)
- Промт-инжениринг (Make, Zapier, Albato, API нейросетей ChatGPT, DeepSeek, GigaChat, YandexGPT)
- Вайб-кодинг (для решения не профильных задач и задач интеграции с документирвоанными API)
- T-SQL (работа с данными в SQL Server, реализация систем, в которызх основной язык программирования Transact SQL).
- QlikView (Построение архитектруры и ETL слоя)
- Tableau (ETL слой и формирование дашбордов)
- Delphi (начало пути в разработке)
- Python (небольшие проекты для себя, теперь и вайб кодинг)
- R (сбор, анализ, визуализация данных)

## Проекты
- Внедрение, кастомизация и отладка корпоративных информационных систем. 
- Разработка нейросетевых ассистентов и интеграция их в процессы предприятия.
- Формирование сложных аналитических отчетов и систем (Проектировани архитектуры, 1C СКД, Qlik).
- Кастомизированные механизмы планирования и контроля за движением ТМЦ.
- Планирование производства.
- Бюджетирования.
- Автоматизация взаимодейстяви CRM.
